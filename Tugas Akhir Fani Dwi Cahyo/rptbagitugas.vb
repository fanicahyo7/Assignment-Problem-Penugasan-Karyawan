...
Public Class rptbagitugas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tugas_Akhir_Fani_Dwi_Cahyo.rptbagitugas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptbagitugas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptbagitugas = New rptbagitugas()
        rpt.Site = Me.Site
        Return rpt
    End Function
