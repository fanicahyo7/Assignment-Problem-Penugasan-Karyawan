...
Public Class rptkaryawan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tugas_Akhir_Fani_Dwi_Cahyo.rptkaryawan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptkaryawan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptkaryawan = New rptkaryawan()
        rpt.Site = Me.Site
        Return rpt
    End Function
