...
Public Class rpttugaskaryawan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tugas_Akhir_Fani_Dwi_Cahyo.rpttugaskaryawan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpttugaskaryawan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpttugaskaryawan = New rpttugaskaryawan()
        rpt.Site = Me.Site
        Return rpt
    End Function
